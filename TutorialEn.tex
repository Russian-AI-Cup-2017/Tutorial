...
\begin{itemize}
    ...
    \item Every $1000$ ticks, starting at $10000$ and not including the last tick, the strategy that have less vehicles gains $1$ score
          point for each $10$ units of difference.
\end{itemize}
