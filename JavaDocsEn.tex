...
\vskip .13in
\hbox{\bf Classes}
\entityintro{ActionType}{l0}{Available player actions.}
\entityintro{CircularUnit}{l1}{This base class describes any circular unit in the game world.}
\entityintro{Facility}{l2}{This class describes a facility.}
\entityintro{FacilityType}{l3}{Facility type.}
\entityintro{Game}{l4}{An instance of this class contains all game constants.}
\entityintro{Move}{l5}{An encapsulated result of each move of your strategy.}
\entityintro{Player}{l6}{The instance of this class contains all the data about player's state.}
\entityintro{TerrainType}{l7}{Terrain type.}
\entityintro{Unit}{l8}{Base class that describes any object (``unit'') in the game world.}
\entityintro{Vehicle}{l9}{Class describing a vehicle.}
\entityintro{VehicleType}{l10}{Vehicle type.}
\entityintro{VehicleUpdate}{l11}{Class that partly describes a vehicle.}
\entityintro{WeatherType}{l12}{Weather type.}
\entityintro{World}{l13}{This class describes a game world.}
...
{\small Available player actions.
 \bl 
 A player can not perform any new action, if during last {\tt game.actionDetectionInterval - 1} game ticks he
 already performed maximum possible actions. At the start of the game this limit is {\tt game.baseActionCount} for
 ...
 fields of a {\tt move} object. If the specified parameters are incorrect or not sufficient, the action will be
 ignored by game simulator. However, each action that is specified and is not {\tt NONE} counts in the list of last
 actions.}
\vskip .1in 
...
\item{
public static final ActionType CLEAR\_AND\_SELECT\begin{itemize}\item{\vskip -.9ex Select units that match specified parameters.
 Deselect units that do not match these parameters.
 The units of other players are automatically excluded.}\end{itemize}
}
\item{
public static final ActionType ADD\_TO\_SELECTION\begin{itemize}\item{\vskip -.9ex Select units that match specified parameters.
 Already selected units stay selected.
 The units of other players are automatically excluded.}\end{itemize}
}
\item{
public static final ActionType DESELECT\begin{itemize}\item{\vskip -.9ex Deselect units that match specified parameters.}\end{itemize}
}
\item{
public static final ActionType ASSIGN\begin{itemize}\item{\vskip -.9ex Assign selected units to the specified group.}\end{itemize}
}
\item{
public static final ActionType DISMISS\begin{itemize}\item{\vskip -.9ex Dismiss selected units from the specified group.}\end{itemize}
}
\item{
public static final ActionType DISBAND\begin{itemize}\item{\vskip -.9ex Disband the group.}\end{itemize}
}
\item{
public static final ActionType MOVE\begin{itemize}\item{\vskip -.9ex Order selected units to move in the specified direction direction.}\end{itemize}
}
\item{
public static final ActionType ROTATE\begin{itemize}\item{\vskip -.9ex Order selected units to rotate around the specified point.}\end{itemize}
}
\item{
public static final ActionType SCALE\begin{itemize}\item{\vskip -.9ex Scale the formation of selected units relative to the specified point.}\end{itemize}
}
\item{
public static final ActionType SETUP\_VEHICLE\_PRODUCTION\begin{itemize}\item{\vskip -.9ex Set up production of the specified vehicle type on factory.}\end{itemize}
}
\item{
public static final ActionType TACTICAL\_NUCLEAR\_STRIKE\begin{itemize}\item{\vskip -.9ex Request tactical nuclear strike.}\end{itemize}
}
\end{itemize}
}
\hide{inherited}{
...
\item{{\bf Returns} - 
the squared range between the specified point and the center of this unit. 
}%end item
\end{itemize}
}%end item
\divideents{getSquaredDistanceTo}
...
\item{{\bf Returns} - 
the squared range between the center of the specified unit and the center of this unit. 
}%end item
\end{itemize}
}%end item
\divideents{getX}
...
{\small This class describes a facility. A facility is a rectangular area on the map.}
\vskip .1in 
\startsubsubsection{Declaration}{
\fbox{\vbox{
...
\sld
\item{{\bf Returns} - 
the capture level of the facility in the range of {\tt -game.maxFacilityCapturePoints} to
 {\tt game.maxFacilityCapturePoints}. The positive level means, that you are capturing this facility.
...
\sld
\item{{\bf Returns} - 
the leftmost X of the facility. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the nonnegative number that is vehicle production progress. For control center the value is always
 {\tt 0}. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the type of the vehicle that this factory produces or {\tt null}. For control center the value is
 always {\tt null}. 
}%end item
\end{itemize}
}%end item
...
\begin{itemize}
\item{
public static final FacilityType CONTROL\_CENTER\begin{itemize}\item{\vskip -.9ex Increases the limit of player actions for {\tt game.additionalActionCountPerControlCenter} per
 {\tt game.actionDetectionInterval} game ticks. Also slightly reduced cooldown of tactical nuclear strikes.}\end{itemize}
}
\item{
public static final FacilityType VEHICLE\_FACTORY\begin{itemize}\item{\vskip -.9ex The factory can produce vehicles of any type.}\end{itemize}
}
\end{itemize}
}
\hide{inherited}{
...
\sld
\item{{\bf Returns} - 
the interval that is used to limit player actions. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the additional action count per each captured control center. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the defence of an ARRV against aerial attacks. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the maximal durability of an ARRV. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the defence of an ARRV against ground attacks. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the amount of ticks to produce an ARRV on a factory. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the repair amount of an ARRV per tick. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the base vision range of an ARRV. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the base action count that player can perform in {\tt actionDetectionInterval} ticks. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the base cooldown of tactical nuclear strike request. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the speed factor of aerial vehicles in clear weather. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the vision range factor of any vehicle that is trying to detect an aerial vehicle in clear weather. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the vision range factor of an aerial vehicle in clear weather. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the speed factor of aerial vehicles in cloud weather. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the vision range factor of any vehicle that is trying to detect an aerial vehicle in cloud weather. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the vision range factor of an aerial vehicle in cloud weather. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the speed of facility capturing per each vehicle inside the facility area. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the amount of score points for capturing a facility. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack range of a fighter against aerial targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack damage of a fighter against aerial targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the defence of a fighter against aerial attacks. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack cooldown of a fighter. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the maximal durability of a fighter. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack range of a fighter against ground targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack damage of a fighter against ground targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the defence of a fighter against ground attacks. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the amount of ticks to produce a fighter on a factory. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the maximal speed of a fighter. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the base vision range of a fighter. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the speed factor of ground vehicles in forest terrain. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the vision range factor of any vehicle that is trying to detect a ground vehicle in forest terrain. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the vision range factor of a ground vehicle in forest terrain. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack range of a helicopter against aerial targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack damage of a helicopter against aerial targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the defence of a helicopter against aerial attacks. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack cooldown of a helicopter. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the maximal durability of a helicopter. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack range of a helicopter against ground targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack damage of a helicopter against ground targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the defence of a helicopter against ground attacks. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the amount of ticks to produce a helicopter on a factory. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the maximal speed of a helicopter. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the base vision range of a helicopter. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack range of an IFV against aerial targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack damage of an IFV against aerial targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the defence of an IFV against aerial attacks. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the maximal durability of an IFV. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack range of an IFV against ground targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack damage of an IFV against ground targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the defence of an IFV against ground attacks. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the amount of ticks to produce an IFV on a factory. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the base vision range of an IFV. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the maximal possible amount of facility capture points. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the damage in the center of a nuclear explosion. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the speed factor of ground vehicles in plain terrain. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the vision range factor of any vehicle that is trying to detect a ground vehicle in plain terrain. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the vision range factor of a ground vehicle in plain terrain. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the speed factor of aerial vehicles in rain weather. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the vision range factor of any vehicle that is trying to detect an aerial vehicle in rain weather. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the vision range factor of an aerial vehicle in rain weather. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the number that is highly recommended to use as a seed for RNG (generator of pseudo-random numbers). 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the speed factor of ground vehicles in swamp terrain. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the vision range factor of any vehicle that is trying to detect a ground vehicle in swamp terrain. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the vision range factor of a ground vehicle in swamp terrain. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the cooldown decrease of tactical nuclear strike request per each captured control center. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the delay between the request of tactical nuclear strike and the nuclear explosion. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the radius of a nuclear explosion. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack range of a tank against aerial targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack damage of a tank against aerial targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the defence of a tank against aerial attacks. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the maximal durability of a tank. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack range of a tank against ground targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the attack damage of a tank against ground targets. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the defence of a tank against ground attacks. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the amount of ticks to produce a tank on a factory. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the base vision range of a tank. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the count of columns in terrain$/$weather maps. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the count of rows in terrain$/$weather maps. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the amount of score points for destroying a single enemy unit. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the amount of score points received for destroying all enemy units. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
{\tt true} if and only if the fog of war is enabled in the current game. 
}%end item
\end{itemize}
}%end item
\end{itemize}
...
\sld
\item{{\bf Returns} - 
the current bottommost Y of selection rectangle. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the current leftmost X of selection rectangle. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the current angular speed limit. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the current rightmost X of selection rectangle. 
}%end item
\end{itemize}
}%end item
\divideents{getTop}
...
\sld
\item{{\bf Returns} - 
the current topmost Y of selection rectangle. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the current X of a point or vector. 
}%end item
\end{itemize}
}%end item
\divideents{getY}
...
\sld
\item{{\bf Returns} - 
the current Y of a point or vector. 
}%end item
\end{itemize}
}%end item
...
Sets the rotation angle.
 \bl 
 This is required parameter for {\tt ActionType.ROTATE}. The positive values mean clockwise rotation.
 \bl 
 The correct values are real numbers in range of {\tt -PI} to {\tt PI} both inclusive.
}%end item
  \end{itemize}
}
\end{itemize}
...
Sets the bottommost Y of selection rectangle.
 \bl 
 This is required parameter for {\tt ActionType.CLEAR\_AND\_SELECT}, {\tt ActionType.ADD\_TO\_SELECTION} and
 {\tt ActionType.DESELECT}, if the group is not set. Otherwise this value will be ignored.
 \bl 
 The correct values are real numbers in range of {\tt top} to {\tt game.worldHeight} both inclusive.
}%end item
  \end{itemize}
}
\end{itemize}
...
Sets the facility ID.
 \bl 
 This is required parameter for {\tt ActionType.SETUP\_VEHICLE\_PRODUCTION}. If there is no factory with this ID
...
Sets the scale factor.
 \bl 
 This is required parameter for {\tt ActionType.SCALE}. The values greater than {\tt 1.0} increase formation
 size, the values less than {\tt 1.0} decrease formation size.
 \bl 
 The correct values are real numbers in range of {\tt 0.1} to {\tt 10.0} both inclusive.
}%end item
  \end{itemize}
}
\end{itemize}
...
Sets the group of units for various actions.
 \bl 
 This parameter is optional for {\tt ActionType.CLEAR\_AND\_SELECT}, {\tt ActionType.ADD\_TO\_SELECTION} and
 {\tt ActionType.DESELECT}. If the group is set for these actions, then all other parameters
 ({\tt vehicleType}, {\tt left}, {\tt top}, {\tt right}, {\tt bottom}) will be ignored.
 \bl 
 This parameter is required for {\tt ActionType.ASSIGN}, {\tt ActionType.DISMISS} and
 {\tt ActionType.DISBAND}. This is the only parameter for {\tt ActionType.DISBAND}.
 \bl 
 The correct values are integers in range of {\tt 1} to {\tt game.maxUnitGroup} both inclusive.
}%end item
  \end{itemize}
}
\end{itemize}
...
Sets the leftmost X of selection rectangle.
 ...
 {\tt ActionType.DESELECT}, if the group is not set. Otherwise this value will be ignored.
 \bl 
 The correct values are real numbers in range of {\tt 0.0} to {\tt right} both inclusive.
}%end item
  \end{itemize}
}
\end{itemize}
...
Sets the angular speed limit.
 \bl 
 This is optional parameter for {\tt ActionType.ROTATE}. If this parameter is set, then {\tt maxSpeed} will be
 ignored.
 \bl 
 The correct values are real numbers in range of {\tt 0.0} to {\tt PI} both inclusive. The special {\tt 0.0}
...
Sets the speed limit.
 \bl 
 This is optional parameter for {\tt ActionType.MOVE}, {\tt ActionType.ROTATE} and {\tt ActionType.SCALE}.
 If for {\tt ActionType.ROTATE} the max angular speed is set, then this parameter will be ignored.
 \bl 
 The correct values are real nonnegative numbers. The special {\tt 0.0} value means that there is no limit.
}%end item
  \end{itemize}
}
\end{itemize}
...
Sets the rightmost X of selection rectangle.
 ...
 {\tt ActionType.DESELECT}, if the group is not set. Otherwise this value will be ignored.
 \bl 
 The correct values are real numbers in range of {\tt left} to {\tt game.worldWidth} both inclusive.
}%end item
  \end{itemize}
}
\end{itemize}
...
Sets the topmost Y of selection rectangle.
 ...
 {\tt ActionType.DESELECT}, if the group is not set. Otherwise this value will be ignored.
 \bl 
 The correct values are real numbers in range of {\tt 0.0} to {\tt bottom} both inclusive.
}%end item
  \end{itemize}
}
\end{itemize}
...
Sets the vehicle ID.
 \bl 
 This is required parameter for {\tt ActionType.TACTICAL\_NUCLEAR\_STRIKE}. The action will be ignored, if there
...
Sets the vehicle type.
 \bl 
 This is optional filter parameter for {\tt ActionType.CLEAR\_AND\_SELECT}, {\tt ActionType.ADD\_TO\_SELECTION}
 and {\tt ActionType.DESELECT}. This parameter will be ignored, if the group is set.
 \bl 
 This is optional filter parameter for {\tt ActionType.SETUP\_VEHICLE\_PRODUCTION}. The production progress will
...
Sets the X of a point or vector.
 \bl 
 This is required parameter for {\tt ActionType.MOVE} and specifies the X offset.
 \bl 
 This is required parameter for {\tt ActionType.ROTATE} and specifies the X of the rotation center.
 \bl 
 This is required parameter for {\tt ActionType.SCALE} and specifies the X of the scale pivot.
 \bl 
 This is required parameter for {\tt ActionType.TACTICAL\_NUCLEAR\_STRIKE} and specifies the X of the explosion
 center.
 \bl 
 The correct values for {\tt ActionType.MOVE} are real numbers in range of {\tt -game.worldWidth} to
 {\tt game.worldWidth} both inclusive. The correct values for {\tt ActionType.ROTATE} and
 {\tt ActionType.SCALE} are real numbers in range of {\tt -game.worldWidth} to {\tt 2.0 * game.worldWidth}
 both inclusive. The correct values for {\tt ActionType.TACTICAL\_NUCLEAR\_STRIKE} are real numbers in range of
 {\tt 0.0} to {\tt game.worldWidth} both inclusive.
}%end item
  \end{itemize}
}
\end{itemize}
...
Sets the Y of a point or vector.
 \bl 
 This is required parameter for {\tt ActionType.MOVE} and specifies the Y offset.
 \bl 
 This is required parameter for {\tt ActionType.ROTATE} and specifies the Y of the rotation center.
 \bl 
 This is required parameter for {\tt ActionType.SCALE} and specifies the Y of the scale pivot.
 \bl 
 This is required parameter for {\tt ActionType.TACTICAL\_NUCLEAR\_STRIKE} and specifies the Y of the explosion
 center.
 \bl 
 The correct values for {\tt ActionType.MOVE} are real numbers in range of {\tt -game.worldHeight} to
 {\tt game.worldHeight} both inclusive. The correct values for {\tt ActionType.ROTATE} and
 {\tt ActionType.SCALE} are real numbers in range of {\tt -game.worldHeight} to {\tt 2.0 * game.worldHeight}
 both inclusive. The correct values for {\tt ActionType.TACTICAL\_NUCLEAR\_STRIKE} are real numbers in range of
 {\tt 0.0} to {\tt game.worldHeight} both inclusive.
}%end item
  \end{itemize}
}
\end{itemize}
...
{\small The instance of this class contains all the data about player's state.}
\vskip .1in 
\startsubsubsection{Declaration}{
\fbox{\vbox{
\hbox{\vbox{\small public 
...
\sld
\item{{\bf Returns} - 
the tick index of this player's next nuclear strike or {\tt -1}. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the nuclear strike spotter vehicle ID or {\tt -1}. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the X of this player's next nuclear strike or {\tt -1.0}. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the Y of this player's next nuclear strike or {\tt -1.0}. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
the amount of ticks remaining before any next action. If this value is {\tt 0}, then the player may
...
\sld
\item{{\bf Returns} - 
the amount of ticks remaining before next tactical nuclear strike request. If this value is {\tt 0},
...
\begin{itemize}
\item{
public static final TerrainType PLAIN\begin{itemize}\item{\vskip -.9ex Plain.}\end{itemize}
}
\item{
public static final TerrainType SWAMP\begin{itemize}\item{\vskip -.9ex Swamp.}\end{itemize}
}
\item{
public static final TerrainType FOREST\begin{itemize}\item{\vskip -.9ex Forest.}\end{itemize}
}
\end{itemize}
}
\hide{inherited}{
...
{\small Class describing a vehicle. Also contains all properties of a circular unit.}
\vskip .1in 
\startsubsubsection{Declaration}{
\fbox{\vbox{
\hbox{\vbox{\small public 
...
\sld
\item{{\bf Returns} - 
maximal range (from center to center) at which this vehicle can attack aerial units. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
damage of one attack dealt to an aerial unit. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
value of defence from aerial units' attacks. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
minimal possible interval between attacks. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
maximal range (from center to center) at which this vehicle can attack ground units. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
damage of one attack dealt to a ground unit. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
value of defence from ground units' attacks. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
list of groups that the vehicle belongs to. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
maximal distance that can be travelled in one tick
...
\sld
\item{{\bf Returns} - 
amount of ticks before the vehicle can attack again.
...
\sld
\item{{\bf Returns} - 
squared maximal range (from center to center) at which this vehicle can attack aerial units. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
squared maximal range (from center to center) at which this vehicle can attack ground units. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
squared maximal range (from center to center) at which this vehicle can detect other objects,
...
\sld
\item{{\bf Returns} - 
maximal range (from center to center) at which this vehicle can detect other objects,
 when not affected by terrain or weather. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
{\tt true} iff the vehicle is aerial. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
{\tt true} iff the vehicle is selected. 
}%end item
\end{itemize}
}%end item
\end{itemize}
...
\begin{itemize}
\item{
public static final VehicleType ARRV\begin{itemize}\item{\vskip -.9ex Armored repair and recovery vehicle. Ground unit.
 Gradually restores durability of nearby vehicles.}\end{itemize}
}
\item{
public static final VehicleType FIGHTER\begin{itemize}\item{\vskip -.9ex Fighter. Aerial unit. Effective against other aerial units. Can not attack ground units.}\end{itemize}
}
\item{
public static final VehicleType HELICOPTER\begin{itemize}\item{\vskip -.9ex Attack helicopter. Aerial unit. Can attack both aerial and ground units.}\end{itemize}
}
\item{
public static final VehicleType IFV\begin{itemize}\item{\vskip -.9ex Infantry fighting vehicle. Ground unit. Can attack both aerial and ground units.}\end{itemize}
}
\item{
public static final VehicleType TANK\begin{itemize}\item{\vskip -.9ex Tank. Ground unit. Effective against other ground units. Can also attack aerial units.}\end{itemize}
}
\end{itemize}
}
\hide{inherited}{
...
{\small Class that partly describes a vehicle. Contains a unique vehicle's identifier as well as all vehicle's fields that
...
\sld
\item{{\bf Returns} - 
current durability, or {\tt 0} if the vehicle has either been destroyed or became invisible to you. 
}%end item
\end{itemize}
}%end item
\divideents{getGroups}
...
\begin{itemize}
\item{
public static final WeatherType CLEAR\begin{itemize}\item{\vskip -.9ex Clear.}\end{itemize}
}
\item{
public static final WeatherType CLOUD\begin{itemize}\item{\vskip -.9ex Cloud.}\end{itemize}
}
\item{
public static final WeatherType RAIN\begin{itemize}\item{\vskip -.9ex Rain.}\end{itemize}
}
\end{itemize}
}
\hide{inherited}{
...
\sld
\item{{\bf Returns} - 
list of facilities (in random order).
...
\sld
\item{{\bf Returns} - 
list of vehicles that had no information availavle in the precious tick.
...
\sld
\item{{\bf Returns} - 
changing field values for each visible vehicle if at least one of these fields has been changed.
...
\vskip .13in
\hbox{\bf Interfaces}
\entityintro{Strategy}{l413}{This interface contains the methods that each strategy should implement.}
\vskip .1in
\rule{\hsize}{.7mm}
\vskip .1in
\newpage
...
{\small This interface contains the methods that each strategy should implement.}
\vskip .1in 
\startsubsubsection{Declaration}{
\fbox{\vbox{
...
\sld\isep
   \item{
\sld
{\tt me} - the owner player of this strategy.}
   \item{
\sld
...
{\tt game} - many game constants.}
   \item{
\sld
{\tt move} - the object that encapsulates all strategy instructions.}
  \end{itemize}
}%end item
\end{itemize}
}%end item
