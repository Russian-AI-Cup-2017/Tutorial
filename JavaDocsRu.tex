...
\vspace{0.50in}
\textsc{\LARGE Правила}\\
\textsc{\small Версия 0.9.5.1 BETA}\\
\vspace{2.75in}
...
Задаёт коэффициент масштабирования.
 ...
 формации юнитов относительно точки ({\tt x}, {\tt y}). При значениях коэффициента больше 1.0 происходит
...
\vskip .13in
\hbox{\bf Interfaces}
\entityintro{Strategy}{l389}{Стратегия --- интерфейс, содержащий описание методов искусственного интеллекта армии.}
\vskip .1in
\rule{\hsize}{.7mm}
\vskip .1in
\newpage
\section{Interfaces}{
\startsection{Interface}{Strategy}{l389}{%
